    ...
    export default {
        ...
        data() {
            return {
                ...
                sendText: '',
                receiveText: '',
                url: 'https://vdept.bdstatic.com/523642455271516956444a6666526964/73447a54376e5772/87d6cb8c3f23b44c0bd753dbaab769453672cdad8ed0a433ea48e537d9605cd9655b99d41c547f0b56ec61a5f3b29a27902aead4bf888b2779da4b1216a28bc5.mp4?auth_key=1587048691-0-0-112d452131a6867b8f5af81ac4f7ddbb'
            }
        },
        methods: {
            send() {
            ...
            initPeer() {
                ...
                this.peerA.onicecandidate = (event) => {
                    if (event.candidate) {
                        ...
                        console.log('peerA onicecandidate')
                    }
                };
...
//                this.channelA.send('Hi you!');
                ...
                this.peerB.onicecandidate = (event) => {
                    if (event.candidate) {
                        ...
                        console.log('peerB onicecandidate')
                    }
                };
                this.allowCall = false;
            },
